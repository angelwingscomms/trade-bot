...
#define LABEL_SL_MULTIPLIER 0.72
#define LABEL_TP_MULTIPLIER 0.12

// Live execution defaults used when live.mq5 input R is false / ATR-risk mode is enabled.
#define DEFAULT_SL_MULTIPLIER 0.72
#define DEFAULT_TP_MULTIPLIER 0.12
#define DEFAULT_LOT_SIZE 0.54
#define DEFAULT_RISK_PERCENT 0.05
#define DEFAULT_LOT_MIN 0.09
